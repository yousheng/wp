...
define('DB_PASSWORD', 'gvs+27386515');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'kwrIR9Imi[lNHZxN@`=^OnP?(|u$<0C4[I~v$XYJ%U&%x;;X(ubG2n}U ?j{5E8}');
define('SECURE_AUTH_KEY',  '[Bt*!]la$a>L].rDw-G)BSU12Df+n!mQDGUHF3Xp|99r^xof0g=J5D;/bFc<-UDD');
define('LOGGED_IN_KEY',    '+[9J<bDq49E3DWCY__hX8c<T2r-w:^tVfr;>6:p]mF} F4*SJ`^MY*~>$glP/y(R');
define('NONCE_KEY',        '~W98w3_D}6ui$[/R$OK~>$4+K^+b$J6Asvo]z~_m#T+w]MtT>idzPp7t_jF;L=S%');
define('AUTH_SALT',        '#y4z,MVa=M`y)}/=>w#kBnTtzkPy$W.hW)m#nA=/!rFqz-YTNwo=KE)j8.R6C:bI');
define('SECURE_AUTH_SALT', '87:8dj)TAMcg4kLV4Y&6WpzIt<x,^JMnk?h(S-=mW^t}ayM(tu#SLWcd&*,**&37');
define('LOGGED_IN_SALT',   'S{4d7;N+v56aA[X2.%fD=hYdGBe/oE!]R3[Ap~IS]4v(5lWg|(S`{(qd+Vk3^Z9A');
define('NONCE_SALT',       '1[+ULRr/>SDZGF{5ga[1y*vsUWxS2We@OZJ [|uz0:YqG6|9m]a.K.CTeA$*}&*,');
