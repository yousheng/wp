...
$hootdu_template_dir = trailingslashit( get_template_directory() );

// Load the Core Library files
require_once( $hootdu_template_dir . 'library/init.php' );

// Load up the Theme files
require_once( $hootdu_template_dir . 'include/hoot-theme.php' );