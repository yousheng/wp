...
add_filter( 'hootdu_custom_image_sizes', 'hootdu_theme_custom_image_sizes', 5 );
 ...
 *
 * Note, When using hootdu_get_image_size_name(), any span below 3 gets upgraded to span3, thereby
 ...
 *
 * Note, order of sizes in this array matters. hootdu_get_image_size_name() automatically returns the
 ...
 * @return array
 */
function hootdu_theme_custom_image_sizes( $sizes ) {
	$sizes = array(

		// Let span3 use 'hoot-medium-thumb' as we need width to be 420 for mobile
		// // 240 x 180 (suitable for span3, calculated using logic of hootdu_get_image_size_name fn)
		// 'hoot-small-thumb' => 315 x 215

		// (calculated using logic of hootdu_get_image_size_name fn)
