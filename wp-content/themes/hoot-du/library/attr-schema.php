...
add_filter( 'hootdu_attr_body',    'hootdu_attr_body',    5    );
add_filter( 'hootdu_attr_header',  'hootdu_attr_header',  5    );
add_filter( 'hootdu_attr_footer',  'hootdu_attr_footer',  5    );
add_filter( 'hootdu_attr_content', 'hootdu_attr_content', 5    );
add_filter( 'hootdu_attr_sidebar', 'hootdu_attr_sidebar', 5, 2 );
add_filter( 'hootdu_attr_menu',    'hootdu_attr_menu',    5, 2 );

# Header attributes.
add_filter( 'hootdu_attr_head',             'hootdu_attr_head',             5 );
add_filter( 'hootdu_attr_branding',         'hootdu_attr_branding',         5 );
add_filter( 'hootdu_attr_site-title',       'hootdu_attr_site_title',       5 );
add_filter( 'hootdu_attr_site-description', 'hootdu_attr_site_description', 5 );

# Post-specific attributes.
add_filter( 'hootdu_attr_page',            'hootdu_attr_page',            5    );
add_filter( 'hootdu_attr_post',            'hootdu_attr_post',            5    );
add_filter( 'hootdu_attr_entry',           'hootdu_attr_post',            5    ); // Alternate for "post".
add_filter( 'hootdu_attr_entry-title',     'hootdu_attr_entry_title',     5    );
add_filter( 'hootdu_attr_entry-author',    'hootdu_attr_entry_author',    5    );
add_filter( 'hootdu_attr_entry-published', 'hootdu_attr_entry_published', 5    );
add_filter( 'hootdu_attr_entry-content',   'hootdu_attr_entry_content',   5    );
add_filter( 'hootdu_attr_entry-summary',   'hootdu_attr_entry_summary',   5, 2 );
add_filter( 'hootdu_attr_entry-terms',     'hootdu_attr_entry_terms',     5, 2 );

# Comment specific attributes.
add_filter( 'hootdu_attr_comment',           'hootdu_attr_comment',           5 );
add_filter( 'hootdu_attr_comment-author',    'hootdu_attr_comment_author',    5 );
add_filter( 'hootdu_attr_comment-published', 'hootdu_attr_comment_published', 5 );
add_filter( 'hootdu_attr_comment-permalink', 'hootdu_attr_comment_permalink', 5 );
add_filter( 'hootdu_attr_comment-content',   'hootdu_attr_comment_content',   5 );
 ...
 * @return array
 */
function hootdu_attr_body( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_header( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_footer( $attr ) {
...
function hootdu_attr_sidebar( $attr, $context ) {
	...
	if ( $context ) {
		...
		$sidebar_name = hootdu_get_sidebar_name( $context );
 ...
 * @return array
 */
function hootdu_attr_head( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_site_title( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_site_description( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_page( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_post( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_entry_title( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_entry_author( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_entry_published( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_entry_content( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_entry_summary( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_entry_terms( $attr, $context ) {
 ...
 * @return array
 */
function hootdu_attr_comment( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_comment_author( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_comment_published( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_comment_permalink( $attr ) {
 ...
 * @return array
 */
function hootdu_attr_comment_content( $attr ) {
