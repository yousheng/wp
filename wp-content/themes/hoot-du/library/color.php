 ...
 * @return array
 */
function hootdu_hex_to_rgb( $hex ) {
 ...
 */
function hootdu_color_lighten( $color, $intensity = 30 ) {
	return hootdu_color( $color, 'lighten', $intensity );
}
 ...
 * @return string Hexa Color
 */
function hootdu_color_darken( $color, $intensity = 30 ) {
	return hootdu_color( $color, 'darken', $intensity );
}
 ...
 * @return string Hexa Color
 */
function hootdu_color_increase( $color, $light_intensity = 30, $dark_intensity = '' ) {
	return hootdu_color( $color, 'increase', $light_intensity, $dark_intensity );
}
 ...
 * @return string Hexa Color
 */
function hootdu_color_decrease( $color, $dark_intensity = 30, $light_intensity = '' ) {
	return hootdu_color( $color, 'decrease', $dark_intensity, $light_intensity );
}
 ...
 * @return string Hexa Color
 */
function hootdu_color( $color, $operation, $intensity1, $intensity2 = 0 ) {
	static $hootdu_color = null; // cache

	if ( $hootdu_color === null ) {
		$hootdu_color = new _Hootdu_Color();
	}

	switch( $operation ) {
		case 'lighten' :
			$color = $hootdu_color->lighten( $color, $intensity1 );
			break;
		case 'darken' :
			$color = $hootdu_color->darken( $color, $intensity1 );
			break;
		case 'increase' :
			$intensity2 = ( empty( $intensity2 ) ) ? $intensity1 : $intensity2;
			$color = $hootdu_color->increase( $color, $intensity1, $intensity2 );
			break;
		case 'decrease' :
			$intensity2 = ( empty( $intensity2 ) ) ? $intensity1 : $intensity2;
			$color = $hootdu_color->decrease( $color, $intensity1, $intensity2 );
			break;
		case 'isdark' :
			return $hootdu_color->isdark( $color );
			break;
	}
...
final class _Hootdu_Color {
	...
	public function lighten( $hex, $intensity ) {
		$hex = hootdu_sanitize_hex( $hex ); // Returns sanitized color with '#'
		if ( empty( $hex ) )
			return null;
	...
	// 	$color = hootdu_color_lighten( '000', 100 );
	// 	var_dump( '000 ' . $color);
	// 	$color = hootdu_color_darken( 'fff', 100 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = hootdu_color_lighten( '000', 0 );
	// 	var_dump( '000 ' . $color);
	// 	$color = hootdu_color_darken( 'fff', 0 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = hootdu_color_lighten( '000', 200 );
	// 	var_dump( '000 ' . $color);
	// 	$color = hootdu_color_darken( 'fff', 200 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = hootdu_color_increase( '#000' );
	// 	var_dump( '000 ' . $color);
	// 	$color = hootdu_color_increase( '#fff' );
	// 	var_dump( 'fff ' . $color);
	// 	$color = hootdu_color_decrease( '#000' );
	// 	var_dump( '000 ' . $color);
	// 	$color = hootdu_color_decrease( '#fff' );
	// 	var_dump( 'fff ' . $color);
	// }
