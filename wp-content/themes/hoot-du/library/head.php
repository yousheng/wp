...
add_action( 'wp_head', 'hootdu_meta_charset', 0 );
add_action( 'wp_head', 'hootdu_meta_viewport', 1 );
add_action( 'wp_head', 'hootdu_meta_generator', 1 );
add_action( 'wp_head', 'hootdu_link_pingback', 3 );
 ...
 * @return void
 */
function hootdu_meta_generator() {
	printf( '<meta name="generator" content="%s %s" />' . "\n", esc_attr( hootdu_data()->template_name ), esc_attr( hootdu_data()->template_version ) );
}
