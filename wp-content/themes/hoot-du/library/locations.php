...
if ( !function_exists( 'hootdu_get_content_template' ) ) :
function hootdu_get_content_template( $deprecated = '', $load = true ) {
	...
	$templates = apply_filters( 'hootdu_content_template_hierarchy', $templates, $post_type );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_archive_content' ) ) :
function hootdu_get_archive_content( $name = null, $load = true ) {

	// Get default values
	if ( empty( $name ) )
		$name = hootdu_get_mod( 'archive_type' );
	...
	if ( ! isset( $archive_templates[ $post_type ][ $nameid ] ) ) {
		...
		$templates = apply_filters( 'hootdu_archive_post_template_hierarchy', $templates, $name, $post_type );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_menu' ) ) :
function hootdu_get_menu( $name = '', $load = true ) {
	...
	$templates = apply_filters( 'hootdu_menu_template_hierarchy', $templates, $name );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_header' ) ) :
function hootdu_get_header( $name = null, $load = true ) {
	...
	$templates = apply_filters( 'hootdu_header_template_hierarchy', $templates, $name );
 ...
 * @return array
 */
if ( !function_exists( 'hootdu_get_comment' ) ) :
function hootdu_get_comment( $comment_type, $load = true ) {
	...
	if ( ! isset( $comment_templates[ $comment_type ] ) ) {
		...
		// Allow devs to filter the template hierarchy.
		$templates = apply_filters( 'hootdu_comment_template_hierarchy', $templates, $comment_type );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_sidebar' ) ) :
function hootdu_get_sidebar( $name = null, $load = true ) {
	...
	$templates = apply_filters( 'hootdu_sidebar_template_hierarchy', $templates, $name );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_widget' ) ) :
function hootdu_get_widget( $name, $load = true ) {
	...
	if ( ! isset( $widget_templates[ $name ] ) ) {
		...
		// Allow devs to filter the template hierarchy.
		$templates = apply_filters( 'hootdu_widget_template_hierarchy', $templates, $name );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_footer' ) ) :
function hootdu_get_footer( $name = null, $load = true ) {
	...
	$templates = apply_filters( 'hootdu_footer_template_hierarchy', $templates, $name );
 ...
 * @return void
 */
if ( !function_exists( 'hootdu_get_template_part' ) ) :
function hootdu_get_template_part( $slug, $name = null, $load = true ) {
	...
	$templates = apply_filters( 'hootdu_get_template_hierarchy', $slug, $name );
