 ...
 * * Style Builder, Color functions, saving values in customize, hootdu_get_mod
 * * Meta Options may also use these functions (probably via filters)
 * * Common functions like hootdu_sanitize_hex and hootdu_sanitize_fa are used throughout including frontend templates
 *
 * @package    Hoot Du
 * @subpackage Library
 */
 ...
 */
if ( !function_exists( 'hootdu_sanitize_html_classes' ) ):
function hootdu_sanitize_html_classes( $class, $fallback = null ) {
	if ( is_string( $class ) ) {
		$class = explode( " ", $class );
	} 
 ...
 */
if ( !function_exists( 'hootdu_sanitize_text' ) ):
function hootdu_sanitize_text( $input ) {
 ...
 * @returns string $output
 */
if ( !function_exists( 'hootdu_sanitize_enum' ) ):
function hootdu_sanitize_enum( $input, $options ) {
	$output = '';
 ...
 */
if ( !function_exists( 'hootdu_sanitize_textarea' ) ):
function hootdu_sanitize_textarea( $input ) {
	return wp_kses_post( $input );
}
endif;
 ...
 * @returns string $output
 */
if ( !function_exists( 'hootdu_sanitize_editor' ) ):
function hootdu_sanitize_editor( $input ) {
 ...
 * @return int|string
 */
if ( !function_exists( 'hootdu_sanitize_range' ) ):
function hootdu_sanitize_range( $value ) {
	if ( is_numeric( $value ) ) {
		return $value;
	}
	return 0;
 ...
 */
if ( !function_exists( 'hootdu_sanitize_checkbox' ) ):
function hootdu_sanitize_checkbox( $input ) {
	if ( $input ) {
		$output = 1;
	} else {
		$output = 0;
 ...
 */
if ( !function_exists( 'hootdu_sanitize_multicheck' ) ):
function hootdu_sanitize_multicheck( $input, $options, $searchkeys = false ) {
	if ( is_array( $input ) ) {
		$format = 'array';
 ...
 */
if ( !function_exists( 'hootdu_sanitize_upload' ) ):
function hootdu_sanitize_upload( $input ) {
	$output = '';
 ...
 */
if ( !function_exists( 'hootdu_sanitize_color' ) ):
function hootdu_sanitize_color( $input ) {
	return ( strpos( $input, ',' ) !== false ) ? hootdu_sanitize_rgba( $input ) : hootdu_sanitize_hex( $input );
}
endif;
 ...
 * @return string Color in hexidecimal notation. "#" is prepended
 */
if ( !function_exists( 'hootdu_sanitize_hex' ) ):
function hootdu_sanitize_hex( $hex ) {
 ...
 */
if ( !function_exists( 'hootdu_sanitize_rgba' ) ):
function hootdu_sanitize_rgba( $rgba ) {
 ...
 */
if ( !function_exists( 'hootdu_sanitize_background_repeat' ) ):
function hootdu_sanitize_background_repeat( $value ) {
	$options = hootdu_enum_background_repeat();
 ...
 * @returns string $value if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_background_position' ) ):
function hootdu_sanitize_background_position( $value ) {
	$options = hootdu_enum_background_position();
	if ( array_key_exists( $value, $options ) ) {
		return $value;
	}
	return '';
 ...
 * @returns string $value if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_background_attachment' ) ):
function hootdu_sanitize_background_attachment( $value ) {
	$options = hootdu_enum_background_attachment();
	if ( array_key_exists( $value, $options ) ) {
		return $value;
	}
	return '';
 ...
 */
if ( !function_exists( 'hootdu_sanitize_background_type' ) ):
function hootdu_sanitize_background_type( $value ) {
	$options = hootdu_enum_background_type();
	if ( array_key_exists( $value, $options ) ) {
		return $value;
	}
	return '';
 ...
 * @returns $value if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_background_pattern' ) ):
function hootdu_sanitize_background_pattern( $value ) {
	$options = hootdu_enum_background_pattern();
	if ( array_key_exists( $value, $options ) ) {
		return $value;
	}
	return '';
 ...
 */
if ( !function_exists( 'hootdu_sanitize_icon' ) ):
function hootdu_sanitize_icon( $input ) {
	$options = hootdu_enum_icons();
 ...
 * @returns string $input if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_fontface' ) ):
function hootdu_sanitize_fontface( $value ) {
	$options = hootdu_enum_font_faces();
 ...
 * @returns string $input if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_font_size' ) ):
function hootdu_sanitize_font_size( $value ) {
	$options = hootdu_enum_font_sizes();
 ...
 * @returns string $input if it is valid
 */
if ( !function_exists( 'hootdu_sanitize_font_style' ) ):
function hootdu_sanitize_font_style( $value ) {
	$options = hootdu_enum_font_styles();
	if ( array_key_exists( $value, $options ) ) {
		return $value;
	}
	return '';
 ...
 * @return string
 */
if ( !function_exists( 'hootdu_sanitize_fa' ) ):
function hootdu_sanitize_fa( $icon ) {
	$icon = apply_filters( 'hootdu_migration_icon', trim( $icon ) );
	$migration = array(
	...
	if ( empty( $migration[$icon] ) ) {
		return ( is_string( $icon ) ) ? hootdu_sanitize_html_classes( $icon ) : '';
	} else {
